    ...
    <style>
        body {
            background:
                ...
                url(../images/summer_time_rendering.png) left top no-repeat;
        ...
        @media only screen and (max-width: 480px) {
            body {
                background:
                    ...
                    url(../images/summer_time_rendering.png) center center no-repeat;
                background-size: cover;
            }
        }
    </style>
...
<body>
    ...
    <main>
        ...
        <div class="anime-description">
            ...
            <p class="genre">Action, Drama, Mystery</p>
            <p>
