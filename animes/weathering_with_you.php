...
$maxEpisodes = '1';
$year = '2019';
$picture = './images/weathering_with_you.png';
$format = 'movie';
$pathToReserve = './reserve/weathering_with_you-reserve.php';
?>
    ...
    <style>
        body {
            background:
                ...
                url(../images/weathering_with_you.png) left top no-repeat;
        ...
        @media only screen and (max-width: 480px) {
            body {
                background:
                    ...
                    url(../images/weathering_with_you.png) center center no-repeat;
                background-size: cover;
            }
        }
    </style>
