...
<head>
    ...
    <style>
        ...
        .poster {
            background: url(../images/your_name.png) no-repeat center center;
        ...
        @media only screen and (max-width: 480px) {
            body {
                background:
                    ...
                    url(../images/your_name.png) center center no-repeat;
                background-size: cover;
            }
        }
    </style>
        ...
        <div class="anime-description">
            ...
            <div class="buttons">
                ...
                <button id="watchTrailerBtn" class="button" type="button"
                    data-youtube="https://www.youtube.com/embed/NooIc3dMncc?autoplay=1&fs=1">
            ...
            <div class="modal-content">
                ...
                <div class="setContent">
                    ...
                    <div class="form-wrapper">
                        ...
                        <br>umber" id="episodes" name="episode" min="0" max="<?php echo htmlspecialchars($maxEpisodes); ?>" value="0" required>
                        <br><br>
