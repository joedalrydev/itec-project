...
$maxEpisodes = '26';
$year = '2019';
$picture = './images/demon_slayer.jpg';
$format = 'tv';
$pathToReserve = './reserve/demon_slayer-reserve-reserve.php';
?>
    ...
    <style>
        body {
            background:
                ...
                url(../images/demon_slayer.jpg) left top no-repeat;
            background-size: cover, 50% 100%;
            background-position: center center, left top;
            background-repeat: no-repeat, no-repeat;
        }
        .poster {
            background: url(../images/demon_slayer.jpg) no-repeat center center;
        ...
        @media only screen and (max-width: 480px) {
            body {
                background:
                    ...
                    url(../images/demon_slayer.jpg) center center no-repeat;
                background-size: cover;
            }
        }
    </style>
    ...
    <main>
        ...
        <div class="anime-description">
            ...
            <button id="watchTrailerBtn" class="button" type="button"
                data-youtube="https://www.youtube.com/embed/VQGCKyvzIM4?autoplay=1&fs=1">
                Watch Trailer
            </button>
        </div>
